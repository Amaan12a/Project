...
namespace OpenCVForUnityExample.DnnModel
{
    ...
    /// </summary>
    public class YOLOv7ObjectDetectorMod
    {
        Size input_size;
        ...
        public YOLOv7ObjectDetectorMod(string modelFilepath, string configFilepath, string classesFilepath, Size inputSize, float confThreshold = 0.25f, float nmsThreshold = 0.45f, int topK = 1000, int backend = Dnn.DNN_BACKEND_OPENCV, int target = Dnn.DNN_TARGET_CPU)
        {
            // initialize
